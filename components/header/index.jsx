...
function Header() {
  ...
  return (
    <>
      ...
      <header
        id="header"
        className={`fixed mx-auto left-0 right-0 top-0 flex flex-wrap justify-self-center  items-center justify-between  px-[2%]  transition-all  duration-500 text-secondaryDark  w-[90%] py-3 2xl:flex-nowrap 2xl:gap-16 rounded-3xl 2xl:rounded-full 2xl:py-6 z-50
       ${
